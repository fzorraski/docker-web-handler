...
public class CreateSnapshotUseCase {
    ...
    private void streamDockerDump(DatabaseService.PgConnectionInfo pgInfo,
                                   String databaseName,
    ...
    private void streamLocalDump(DatabaseService.PgConnectionInfo pgInfo,
                                  String databaseName,
                                  DatabaseSnapshot.Format format,
                                  OutputStream output) throws Exception {
        List<String> cmd = buildPgDumpCommand(pgInfo, databaseName, format);
    ...
    private List<String> buildPgDumpCommand(DatabaseService.PgConnectionInfo pgInfo,
                                             String databaseName,
                                             DatabaseSnapshot.Format format) {
